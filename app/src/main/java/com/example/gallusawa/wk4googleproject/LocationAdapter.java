...
import com.example.gallusawa.wk4googleproject.model.Result;
...
public class LocationAdapter extends RecyclerView.Adapter<LocationAdapter.ViewHolder> {
    ...
    public LocationAdapter(List<Result> placeList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        c = parent.getContext();
        View view = LayoutInflater.from(c).inflate(R.layout.location, parent, false);
